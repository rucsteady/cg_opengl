...
public class Matrix4 {
	...
	public float[] matrval = new float[16];

	public float[] getValuesAsArray() {

		this.matrval[0] = this.mat[0];
		this.matrval[1] = this.mat[4];
		this.matrval[2] = this.mat[8];
		this.matrval[3] = this.mat[12];

		this.matrval[4] = this.mat[1];
		this.matrval[5] = this.mat[5];
		this.matrval[6] = this.mat[9];
		this.matrval[7] = this.mat[13];

		this.matrval[8] = this.mat[2];
		this.matrval[9] = this.mat[6];
		this.matrval[10] = this.mat[10];
		this.matrval[11] = this.mat[14];

		this.matrval[12] = this.mat[3];
		this.matrval[13] = this.mat[7];
		this.matrval[14] = this.mat[11];
		this.matrval[15] = this.mat[15];
